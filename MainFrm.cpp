...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CCuckoo2View), CSize(390, 300), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMainViewDlg), CSize(300, 300), pContext);
